...
export function generateDemoGraph(): GraphData {
  const nodes: GraphNode[] = [
    // Buyers
    {
      ...
      name: "Agent Alice",
      type: "Buyer",
      properties: { protocol: "ACP", budget: "$2,400" },
    },
    {
      id: "b2",
      name: "Agent Bob",
      type: "Buyer",
      properties: { protocol: "x402", budget: "$1,800" },
    },
    {
      id: "b3",
      name: "Agent Carol",
      type: "Buyer",
      properties: { protocol: "AP2", budget: "$3,100" },
    },
    {
      id: "b4",
      name: "Agent Dave",
      type: "Buyer",
      properties: { protocol: "MPP", budget: "$950" },
    },
    {
      id: "b5",
      name: "Agent Eve",
      type: "Buyer",
      properties: { protocol: "ATXP", budget: "$4,200" },
    },
    ...
    // Merchants
    {
      ...
      name: "NovaParts Co",
      type: "Merchant",
      properties: { category: "Electronics", rating: "4.8" },
    },
    {
      id: "m2",
      name: "GreenLeaf Market",
      type: "Merchant",
      properties: { category: "Organic Goods", rating: "4.5" },
    },
    {
      id: "m3",
      name: "ByteForge Labs",
      type: "Merchant",
      properties: { category: "Software", rating: "4.9" },
    },
    ...
    // Products
    {
      ...
      name: "GPU Cluster v4",
      type: "Product",
      properties: { price: "$899", sku: "NP-GPU-04" },
    },
    {
      id: "p2",
      name: "Neural Coprocessor",
      type: "Product",
      properties: { price: "$1,249", sku: "NP-NCP-01" },
    },
    {
      id: "p3",
      name: "Organic Dataset Pack",
      type: "Product",
      properties: { price: "$45", sku: "GL-ODP-12" },
    },
    {
      id: "p4",
      name: "Inference API Key",
      type: "Product",
      properties: { price: "$120/mo", sku: "BF-IAK-01" },
    },
    {
      id: "p5",
      name: "Edge TPU Module",
      type: "Product",
      properties: { price: "$349", sku: "NP-TPU-02" },
    },
    {
      id: "p6",
      name: "Training Pipeline SaaS",
      type: "Product",
      properties: { price: "$299/mo", sku: "BF-TPS-03" },
    },
    ...
    // Transactions
    {
      ...
      name: "TXN-0x7a3f",
      type: "Transaction",
      properties: { amount: "$899", status: "settled", protocol: "ACP" },
    },
    {
      id: "t2",
      name: "TXN-0x9b1c",
      type: "Transaction",
      properties: { amount: "$120", status: "pending", protocol: "x402" },
    },
    {
      id: "t3",
      name: "TXN-0x4e8d",
      type: "Transaction",
      properties: { amount: "$349", status: "settled", protocol: "AP2" },
    },
  ];
